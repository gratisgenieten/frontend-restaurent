export const en = {
	common: {
		...
		Clear: 'Clear',
		Apply: 'Apply',
		'Min price': 'Transactie van',
		'Max price': 'Transactie tot',
		Filters: 'Filters',
		'Show map': 'Show map',
		'On sale': 'On sale',
		'Hosted by': 'Hosted by',
	...
	HeroSearchForm: {
		Location: 'Selecteer stad',
		Locations: 'Selecteer stads',
		CheckIn: 'Check In',
		CheckOut: 'Check Out',
		...
		'Where are you going?': 'Waar ga jij GratisGenieten?',
		'Add dates': 'Add dates',
		Date: 'Date',
		search: 'Search',
	...
	accountPage: {
		...
		'Saved listings': 'Bewaarde deals',
		'Payments & payouts': 'Payments & payouts',
		'Payout methods': 'Payout methods',
		'Add payout method': 'Start verificatiebetaling',
