...
export interface CarDlistingStayDetailProps {
	className?: string
	taxonomy: TaxonomyType
}

const CarDlistingStayDetail: FC<CarDlistingStayDetailProps> = ({
	className = '',
	taxonomy,
}) => {
	const { count, name, href = '/listing-stay-detail', thumbnail } = taxonomy
	return (
		<Link href={'/listing-stay-detail'} className={`nc-CardCategory3 flex flex-col ${className}`}>
			<div
...
export default CarDlistingStayDetail
