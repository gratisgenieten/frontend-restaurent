...
export interface SectionSliderNewCategoriesWebShopsProps {
	className?: string
...
const SectionSliderNewCategoriesWebShops: FC<SectionSliderNewCategoriesWebShopsProps> = ({
	...
	return (
		<div className={`nc-SectionSliderNewCategories ${className}`}>
			<Heading desc={subHeading} isCenter={sliderStyle === 'style1'}>
				{heading}
			</Heading>
...
export default SectionSliderNewCategoriesWebShops
