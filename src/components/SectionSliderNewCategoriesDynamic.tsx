...
import CardCategoryCustom3 from './CardCategoryCustom3'

export interface SectionSliderNewCategoriesDynamicProps {
	className?: string
...
const DEMO_CATS: TaxonomyType[] = [
	...
	},
	{
		...
		name: 'Farm House',
		taxonomy: 'category',
		thumbnail:'https://images.pexels.com/photos/248837/pexels-photo-248837.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
	},
	{
		id: '5',
		href: '/listing-stay-map',
		name: 'Dome House',
		taxonomy: 'category',
		thumbnail: 'https://images.pexels.com/photos/3613236/pexels-photo-3613236.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
...
const SectionSliderNewCategoriesDynamic: FC<SectionSliderNewCategoriesDynamicProps> = ({
	...
	return (
		<div className={`nc-SectionSliderNewCategoriesDynamic ${className}`}>
...
export default SectionSliderNewCategoriesDynamic
