...
import CarDlistingStayDetail from './CarDlistingStayDetail'

export interface SectionSliderNewCategoriesListingStayDetailProps {
	className?: string
...
const SectionSliderNewCategoriesListingStayDetail: FC<SectionSliderNewCategoriesListingStayDetailProps> = ({
	...
	const renderCard = (item: TaxonomyType) => {
		switch (categoryCardType) {
			case 'card3':
				return <CarDlistingStayDetail taxonomy={item} />
...
export default SectionSliderNewCategoriesListingStayDetail
